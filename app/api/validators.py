...
async def check_name_duplicate(
    ...
    """Проверить существование в БД переговорки с переданным названием."""
...
async def check_meeting_room_exists(
    ...
    """Проверить существование переговорки по id."""
...
async def check_reservation_intersections(**kwargs) -> None:
    """Проверить, что запрошенный интервал не пересекается по времени
    с ранее созданными объектами"""
...
async def check_reservation_before_edit(
    ...
    """Проверить, существует ли запрошенный объект бронирования и
    проверить, является ли редактор создателем брони."""
