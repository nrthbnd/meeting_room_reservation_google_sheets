...
from app.api.validators import (
    check_meeting_room_exists, check_reservation_before_edit,
...
async def update_reservation(
    ...
    """Обновить время брони переговорки
...
async def get_reservations(
    ...
    """Вернуть список всех объектов бронирования
