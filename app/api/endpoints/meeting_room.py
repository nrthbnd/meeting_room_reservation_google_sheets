...
async def get_all_meeting_rooms(
    ...
    """Получить список объектов всех переговорок."""
...
async def partially_update_meeting_room(
    ...
    """Частично обновить данные о переговорке (только для суперюзеров)."""
...
async def remove_meeting_room(
    ...
    """Удалить переговорку по id (только для суперюзеров)."""
    meeting_room = await check_meeting_room_exists(
        meeting_room_id, session
    )
...
async def get_reservations_for_room(
    ...
    """Получить все бронирования для переговорки по ее id."""
