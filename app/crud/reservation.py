...
class CRUDReservation(CRUDBase):
    ...
    async def get_reservations_at_the_same_time(
        ...
        """Проверить, свободен ли запрошенный интервал времени."""
    ...
    async def get_future_reservations_for_room(
        ...
        """Получить будущие бронирования конкретной переговорки по ее id."""
    ...
    async def get_by_user(
        ...
        """Получить бронирования переговорок конкретного пользователя."""
        reservations = await session.execute(
            select(Reservation).where(
    ...
    async def get_count_res_at_the_same_time(
        ...
        """Получить список словарей с данными о том, сколько раз
        за указанный период была забронирована каждая переговорка."""
        reservations = await session.execute(
